...
.valid-tooltip {
  ...
  line-height: 1.5;
  color: #fff;
  background-color: rgba(64, 198, 46, 0.9);
  border-radius: 0.25rem;
}
...
.custom-select.is-valid:focus {
  border-color: #40c62e;
  box-shadow: 0 0 0 0.2rem rgba(64, 198, 46, 0.25);
}
...
.was-validated .custom-control-input:valid:checked ~ .custom-control-label::before, .custom-control-input.is-valid:checked ~ .custom-control-label::before {
  background-color: #60d651;
}
.was-validated .custom-control-input:valid:focus ~ .custom-control-label::before, .custom-control-input.is-valid:focus ~ .custom-control-label::before {
  box-shadow: 0 0 0 1px #fff, 0 0 0 0.2rem rgba(64, 198, 46, 0.25);
}
...
.btn-success:focus, .btn-success.focus {
  box-shadow: 0 0 0 0.2rem rgba(64, 198, 46, 0.5);
}
...
.custom-control-input:focus ~ .custom-control-label::before {
  box-shadow: 0 0 0 1px #fff, 0 0 0 0.2rem rgba(0, 191, 255, 0.25);
}
...
.custom-select:focus {
  border-color: #80dfff;
  outline: 0;
  box-shadow: 0 0 0 0.2rem rgba(128, 223, 255, 0.5);
}
...
.bg-success {
  background-color: #40c62e !important;
}

a.bg-success:hover, a.bg-success:focus,
button.bg-success:hover,
button.bg-success:focus {
  background-color: #339d24 !important;
}
...
a.text-secondary:hover, a.text-secondary:focus {
  color: #701ac0 !important;
}

.text-success {
  color: #40c62e !important;
}

a.text-success:hover, a.text-success:focus {
  color: #339d24 !important;
}
