...
<div class="text">
  <div class="text-inner">
    <h1>Teste Finalizado!</h1>

    <h2>Suas respostas foram recebidas, agora é só aguardar que logo entraremos em contato.</h2>

    <div id="home" class="button">
      <h3><a href="<?= base_url() ?>" style="text-decoration: none; color: #395d6d">HOME</a></h3>
    </div>
	</div>
