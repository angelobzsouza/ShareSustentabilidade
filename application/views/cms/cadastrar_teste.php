...
<html>
	...
	<header id="fh5co-header" class="fh5co-cover fh5co-cover-sm fundo-cadastrar-teste" role="banner">
		...
		<div class="container">
			<div class="row justify-content-center">
				<div class="col-10 col-md-8 col-lg-5">
					<form id="form_conteudo" method="POST" action="<?= base_url('cms/testes/store') ?>">
					  <div class="form-group">
					    <input type="text" class="form-control" id="nome" name="nome" aria-describedby="nome_teste" placeholder="Nome do Teste" maxlength="30" required>
					  </div>
					  <div class="form-group">
					  ...
					  <div class="form-group">
					  	<input type="number" name="qtde_questoes" id="qtde_questoes" class="form-control" aria-describedby="quatidade_questoes" min="1" placeholder="Quatidade de Questões" stpe="1" required>
					  </div>
