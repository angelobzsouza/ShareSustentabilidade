...
<html>
	...
	<header id="fh5co-header" class="fh5co-cover fh5co-cover-sm fundo-cadastrar-curso" role="banner">
		...
		<div class="container">
			<div class="row justify-content-center">
				<div class="col-10 col-md-8 col-lg-6 text-center">
					<form action="<?= base_url('cms/cursos/salvaCurso') ?>" method="POST" id="form_curso">
						<input type="text" class="form-control mb-3" name="nome" id="name" required maxlength="45" placeholder="Nome">
