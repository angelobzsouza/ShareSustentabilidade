...
<html>
	...
	<header id="fh5co-header" class="fh5co-cover fh5co-cover-sm fundo-lista-questoes" role="banner">
				...
				<div class="col-12 text-center">
					<div class="display-t">
						<div class="display-tc animate-box" data-animate-effect="fadeIn">
							<h1>Questões</h1>
							<h5 class="text-white"><?= $teste->Nome ?></h5>
						</div>
					</div>
				</div>
			</div>
	...
	<section id="fh5co-blog">
		<div class="container">
			<h5 class="text-right"><a href="<?= base_url('cms/testes/createQuestao/'.$teste->ID) ?>" class="link text-primary">Nova Questão</a></h5>
			<table class="table">
				<thead>
					<tr>
						<th>Questão</th>
				...
				<tbody>
					<?php foreach($questoes as $questao)  {?>
						<tr id="linha<?= $questao->ID ?>">
							<td><?= substr($questao->Questao, 0 , 20)."..." ?></td>
							<td><?= $questao->Resposta ?></td>
							<td class="text-right"><button class="link text-danger" onclick="excluiQuestao(<?= $questao->ID ?>)">Excluir</button></td>
						</tr>
					<?php } ?>
				</tbody>
			</table>
