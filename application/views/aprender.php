...
<html>
	...
	<header id="fh5co-header" class="fh5co-cover fh5co-cover-sm fundo-aprender" role="banner">
	...
	<section class="container">
		<table class="table">
			...
			<tbody>
				<!-- Dentro do foreach é criada uma linha para cada curso -->
				<?php foreach ($cursos as $curso) { ?>
					<tr>
						<td><?= $curso->curso_nome ?></td>
						<td><?= $curso->professor_a_nome ?></td>
						<td><a href="<?= base_url('cursos/curso/'.$curso->curso_ID) ?>">ver</a></td>
					</tr>
				<?php } ?>
			</tbody>
		</table>
